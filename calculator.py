# Simple Calculator in Python with Scientific Operations

# This calculator performs basic arithmetic operations and scientific functions:
# Addition, Subtraction, Multiplication, Division, Power, Square Root, Sine, Cosine, Logarithm
...
def square_root(x):
    ...
    if x < 0:
        return "Error! Square root requires non-negative input."
    return math.sqrt(x)
...
def logarithm(x):
    ...
    if x <= 0:
        return "Error! Logarithm requires positive input."
    return math.log(x)

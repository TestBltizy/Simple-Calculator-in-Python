# Simple Calculator in Python with Scientific Computing Functions

# This calculator performs basic arithmetic operations and scientific computations:
# Addition, Subtraction, Multiplication, Division, Power, Square Root, Sine, Cosine, and Logarithm

# Import math module functions for scientific operations
...
# Define single-operand operations
single_operand_operations = ['6', '7', '8', '9']

# Conditional operand collection based on operation type
try:
    if choice in single_operand_operations:
        # Single operand operations: square root, sine, cosine, logarithm
        num1 = float(input("Enter number: "))
    else:
        # Dual operand operations: add, subtract, multiply, divide, power
